...
![App screenshot]({{ site.baseurl }}public/images/attr_rules_result.png){: .center-image }
...
![App screenshot]({{ site.baseurl }}public/images/log_rules_result.png){: .center-image }
